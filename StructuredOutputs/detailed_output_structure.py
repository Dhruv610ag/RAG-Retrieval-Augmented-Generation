...
class Review(TypedDict):
    key_themes:Annotated[Optional[list[str]], "must write down all the important concept discussed in the review in a list"]
    summary: Annotated[str, "must write a brief summary of the review"]
    sentiment:Annotated[str, "must classify the sentiment of the review as Positive, Negative or Neutral"]
    pros: Annotated[Optional[list[str]], "must list the positive aspects mentioned in the review in a list"]
    cons: Annotated[Optional[list[str]], "must list the negative aspects mentioned in the review in a list"]
